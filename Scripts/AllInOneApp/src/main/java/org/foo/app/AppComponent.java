...
//public class AppComponent implements Application  {
    ...
    public void innerCom(){
        ...
        Ip4Address srcIp = null;
        TpPort srcPort = null;
        String infoFromSensor = null;
        ...
        while(work){
            ...
            try{
                ...
                infoFromSensor = inFromClient.readLine();
                log.info(("##### Received:"+ infoFromSensor + " #####"));
            } catch(IOException e){
            ...
            if (infoFromSensor != null){
                String[] splitted = infoFromSensor.split("\\|");
                // [0] - IP; [1] - Porta; [2] - Score
                outPort = outPort.portNumber("3");
                srcMac = srcMac.valueOf("00:00:00:00:00:01");
                srcIp = srcIp.valueOf(splitted[0]);
                srcPort = srcPort.tpPort(Integer.parseInt(splitted[1]));
